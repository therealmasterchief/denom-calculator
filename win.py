...
window=Tk()
window.title('denom calculator')
window.geometry("800x800")

upload=Image.open('coding.jpg')
upload=upload.resize("700x700")
image=ImageTk.PhotoImage(upload)
label=Label(window,image=image,bg='light blue')
label.place(x=380, y=120)
label1= Label(window,text="Hey user! Welcome to the denomination counter.",bg='light blue')
